...
class UserProfileUpdateForm(forms.ModelForm):
    ...
    dob = forms.DateTimeField(label='Date of Birth',input_formats=['%Y-%m-%d','%m,/%d,/%Y', '%m/%d/%y'], widget=forms.SelectDateWidget(years=range(1930,2019)))
    bio = forms.CharField(max_length = 250, label = "Biography", 
